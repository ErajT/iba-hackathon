...
export function Layout({ children }) {
  ...
  return (
    <SidebarProvider open={sidebarOpen} onOpenChange={(o)=>setSidebarOpen(o)}>
      <div className={`grid h-screen w-full ${sidebarOpen ? 'grid-cols-[250px_1fr]' : 'sm:grid-cols-[1px_1fr] grid-cols-[250px_1fr]'} bg-[#e5f8fd] text-[#075064] dark:text-[gray-50] dark:bg-[#08242c]`}>
        {/* Sidebar Wrapper */}
