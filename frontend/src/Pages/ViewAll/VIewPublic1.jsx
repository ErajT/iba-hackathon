...
const AdminCard = ({ title, description, num, createdAt, creator, id }) => (
...
<CardHeader className="text-center">
  ...
  <div className="flex flex-wrap justify-center gap-2 mt-2">
      <span className="px-3 py-1 text-xs font-semibold text-white bg-gray-800 rounded-full">Science</span>
      <span className="px-3 py-1 text-xs font-semibold text-white bg-gray-800 rounded-full">Technology</span>
      <span className="px-3 py-1 text-xs font-semibold text-white bg-gray-800 rounded-full">Research</span>
  </div>
